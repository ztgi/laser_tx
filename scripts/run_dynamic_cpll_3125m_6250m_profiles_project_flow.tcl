...
set report_dir "D:/FPGA_Learn/laser_tx/reports/dynamic_rate_cpll_3125m_6250m_profiles"
set artifact_dir "D:/FPGA_Learn/laser_tx/reports/dynamic_rate_cpll_3125m_6250m_profiles/artifacts"
...
open_run impl_1
report_timing_summary -file "$report_dir/timing_summary_dynamic_cpll_3125m_6250m_profiles.rpt"
report_clocks -file "$report_dir/clocks_dynamic_cpll_3125m_6250m_profiles.rpt"
report_utilization -file "$report_dir/utilization_dynamic_cpll_3125m_6250m_profiles.rpt"
report_debug_core -full_path -file "$report_dir/debug_cores_dynamic_cpll_3125m_6250m_profiles.rpt"
write_debug_probes -force $ltx_path

if {[file exists $bit_path]} {
    file copy -force $bit_path "$artifact_dir/laser_tx_board_top_dynamic_cpll_3125m_6250m_profiles.bit"
}
if {[file exists $ltx_path]} {
    file copy -force $ltx_path "$artifact_dir/laser_tx_board_top_dynamic_cpll_3125m_6250m_profiles.ltx"
}
file copy -force "$report_dir/timing_summary_dynamic_cpll_3125m_6250m_profiles.rpt" "$artifact_dir/timing_summary_dynamic_cpll_3125m_6250m_profiles.rpt"
file copy -force "$report_dir/debug_cores_dynamic_cpll_3125m_6250m_profiles.rpt" "$artifact_dir/debug_cores_dynamic_cpll_3125m_6250m_profiles.rpt"
file copy -force "$report_dir/utilization_dynamic_cpll_3125m_6250m_profiles.rpt" "$artifact_dir/utilization_dynamic_cpll_3125m_6250m_profiles.rpt"

set final ""
set artifact_bit_path "$artifact_dir/laser_tx_board_top_dynamic_cpll_3125m_6250m_profiles.bit"
set artifact_ltx_path "$artifact_dir/laser_tx_board_top_dynamic_cpll_3125m_6250m_profiles.ltx"
...
append final "timing_report=$report_dir/timing_summary_dynamic_cpll_3125m_6250m_profiles.rpt\n"
append final "utilization_report=$report_dir/utilization_dynamic_cpll_3125m_6250m_profiles.rpt\n"
append final "debug_report=$report_dir/debug_cores_dynamic_cpll_3125m_6250m_profiles.rpt\n"
