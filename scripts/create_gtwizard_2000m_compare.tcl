# Create an isolated 2000 Mb/s GT Wizard comparison project.
#
# This script must not open or modify laser_tx.xpr.  It copies the current
# Profile 0 XCI into reports/ and asks Vivado to resolve a 2.0 Gb/s variant
# in a throw-away project so the generated XCI/properties/example design can
# be inspected before any static wrapper work is attempted.

set script_dir [file dirname [file normalize [info script]]]
set project_dir [file dirname $script_dir]
set source_xci [file join $project_dir laser_tx.srcs sources_1 ip gtwizard_0 gtwizard_0.xci]
set out_root [file join $project_dir reports gt_dynamic_rate_2g_static gtwizard_2000m_compare]
...
set prop_report [file join $out_root gtwizard_2000m_selected_properties.txt]
set log_report [file join $out_root gtwizard_2000m_generation_summary.txt]
...
create_project gt_2000m_compare $work_dir -part xc7z100ffg900-2 -force
...
set set_log {}
foreach {prop value} {
    CONFIG.identical_val_tx_line_rate 2.0
    CONFIG.gt0_val_tx_line_rate       2.0
    CONFIG.gt0_val_rx_line_rate       2.0
...
if {!$set_ok} {
    ...
    puts $fh $set_log
    close $fh
    fail "One or more 2000M GT Wizard properties could not be set. See $log_report"
}
...
puts $fh "# Selected GT Wizard 2000M comparison properties"
