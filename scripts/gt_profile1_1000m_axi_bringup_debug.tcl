# Insert a stable AXI/FCLK-domain bring-up ILA for static 1000M Profile 1.
#
...
# or MMCM DRP.  It only changes debug instrumentation in the isolated 1000M
# implementation.
...
proc dbg_select_net_from_candidates {description candidates {preferred_patterns {}}} {
    ...
    if {[llength $candidates] == 0} {
        error "1000M AXI bring-up ILA insertion failed: no net found for $description."
    }
...
proc dbg_require_one_net {description patterns {preferred_patterns {}}} {
    ...
    if {[llength $candidates] == 0} {
        error "1000M AXI bring-up ILA insertion failed: no net found for $description using patterns '$patterns'."
    }
...
set bringup_core_name ila_1000m_bringup_axi
...
dbg_connect_probe $bringup_core 0  "cplllock_axi" \
    [dbg_require_one_net "cplllock_axi" [list "*cplllock_sync*"] [list "u_laser_gt_tx_profile1_1000m/cplllock_sync" "*u_laser_gt_tx_profile1_1000m/cplllock_sync"]]
dbg_connect_probe $bringup_core 1  "txresetdone_axi" \
    [dbg_require_one_net "txresetdone_axi" [list "*txresetdone_sync*"] [list "u_laser_gt_tx_profile1_1000m/txresetdone_sync" "*u_laser_gt_tx_profile1_1000m/txresetdone_sync"]]
dbg_connect_probe $bringup_core 2  "tx_mmcm_locked_axi" \
    [dbg_require_one_net "tx_mmcm_locked_axi" [list "*tx_mmcm_locked_sync*"] [list "u_laser_gt_tx_profile1_1000m/tx_mmcm_locked_sync" "*u_laser_gt_tx_profile1_1000m/tx_mmcm_locked_sync"]]
dbg_connect_probe $bringup_core 3  "gt_ready_axi" \
    [dbg_require_one_net "gt_ready_axi" [list "*gt_ready_ctrl*"] [list "u_laser_gt_tx_profile1_1000m/gt_ready_ctrl" "*u_laser_gt_tx_profile1_1000m/gt_ready_ctrl"]]
dbg_connect_probe $bringup_core 4  "txusrclk2_alive_axi" \
    [dbg_require_one_net "txusrclk2_alive_axi" [list "*txusrclk2_alive_axi*"] [list "u_laser_gt_tx_profile1_1000m/txusrclk2_alive_axi" "*u_laser_gt_tx_profile1_1000m/txusrclk2_alive_axi"]]
dbg_connect_probe $bringup_core 5  "txusrclk2_toggle_axi" \
    [dbg_require_one_net "txusrclk2_toggle_axi" [list "*txusrclk2_toggle_axi*"] [list "u_laser_gt_tx_profile1_1000m/txusrclk2_toggle_axi" "*u_laser_gt_tx_profile1_1000m/txusrclk2_toggle_axi"]]
dbg_connect_probe $bringup_core 6  "txusrclk2_freq_counter_axi[31:0]" \
    [dbg_require_bus_nets "txusrclk2_freq_counter_axi" "u_laser_gt_tx_profile1_1000m/txusrclk2_freq_counter_axi" 31 0]
