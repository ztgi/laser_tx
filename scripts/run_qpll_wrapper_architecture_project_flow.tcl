...
set report_dir "D:/FPGA_Learn/laser_tx/reports/qpll_wrapper_architecture"
set artifact_dir "D:/FPGA_Learn/laser_tx/reports/qpll_wrapper_architecture/artifacts"
...
open_run impl_1
report_timing_summary -file "$report_dir/timing_summary_qpll_wrapper_architecture.rpt"
report_clocks -file "$report_dir/clocks_qpll_wrapper_architecture.rpt"
report_utilization -file "$report_dir/utilization_qpll_wrapper_architecture.rpt"
report_debug_core -full_path -file "$report_dir/debug_cores_qpll_wrapper_architecture.rpt"
write_debug_probes -force $ltx_path

if {[file exists $bit_path]} {
    file copy -force $bit_path "$artifact_dir/laser_tx_board_top_qpll_wrapper_architecture.bit"
}
if {[file exists $ltx_path]} {
    file copy -force $ltx_path "$artifact_dir/laser_tx_board_top_qpll_wrapper_architecture.ltx"
}
file copy -force "$report_dir/timing_summary_qpll_wrapper_architecture.rpt" "$artifact_dir/timing_summary_qpll_wrapper_architecture.rpt"
file copy -force "$report_dir/debug_cores_qpll_wrapper_architecture.rpt" "$artifact_dir/debug_cores_qpll_wrapper_architecture.rpt"
file copy -force "$report_dir/utilization_qpll_wrapper_architecture.rpt" "$artifact_dir/utilization_qpll_wrapper_architecture.rpt"

set final ""
set artifact_bit_path "$artifact_dir/laser_tx_board_top_qpll_wrapper_architecture.bit"
set artifact_ltx_path "$artifact_dir/laser_tx_board_top_qpll_wrapper_architecture.ltx"
...
append final "timing_report=$report_dir/timing_summary_qpll_wrapper_architecture.rpt\n"
append final "utilization_report=$report_dir/utilization_qpll_wrapper_architecture.rpt\n"
append final "debug_report=$report_dir/debug_cores_qpll_wrapper_architecture.rpt\n"
