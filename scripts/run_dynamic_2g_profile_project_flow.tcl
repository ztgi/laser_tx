...
set report_dir "D:/FPGA_Learn/laser_tx/reports/dynamic_rate_500m_1000m_2000m/dynamic_2g_profile"
set artifact_dir "D:/FPGA_Learn/laser_tx/reports/dynamic_rate_500m_1000m_2000m/artifacts"
...
open_run impl_1
report_timing_summary -file "$report_dir/timing_summary_dynamic_500m_1000m_2000m.rpt"
report_clocks -file "$report_dir/clocks_dynamic_500m_1000m_2000m.rpt"
report_utilization -file "$report_dir/utilization_dynamic_500m_1000m_2000m.rpt"
report_debug_core -full_path -file "$report_dir/debug_cores_dynamic_500m_1000m_2000m.rpt"
write_debug_probes -force $ltx_path

if {[file exists $bit_path]} {
    file copy -force $bit_path "$artifact_dir/laser_tx_board_top_dynamic_500m_1000m_2000m.bit"
}
if {[file exists $ltx_path]} {
    file copy -force $ltx_path "$artifact_dir/laser_tx_board_top_dynamic_500m_1000m_2000m.ltx"
}
file copy -force "$report_dir/timing_summary_dynamic_500m_1000m_2000m.rpt" "$artifact_dir/timing_summary_dynamic_500m_1000m_2000m.rpt"
file copy -force "$report_dir/debug_cores_dynamic_500m_1000m_2000m.rpt" "$artifact_dir/debug_cores_dynamic_500m_1000m_2000m.rpt"
file copy -force "$report_dir/utilization_dynamic_500m_1000m_2000m.rpt" "$artifact_dir/utilization_dynamic_500m_1000m_2000m.rpt"

set final ""
set artifact_bit_path "$artifact_dir/laser_tx_board_top_dynamic_500m_1000m_2000m.bit"
set artifact_ltx_path "$artifact_dir/laser_tx_board_top_dynamic_500m_1000m_2000m.ltx"
...
append final "timing_report=$report_dir/timing_summary_dynamic_500m_1000m_2000m.rpt\n"
append final "utilization_report=$report_dir/utilization_dynamic_500m_1000m_2000m.rpt\n"
append final "debug_report=$report_dir/debug_cores_dynamic_500m_1000m_2000m.rpt\n"
