...
set report_dir "D:/FPGA_Learn/laser_tx/reports/oscilloscope_debug_outputs"
set artifact_dir "D:/FPGA_Learn/laser_tx/reports/oscilloscope_debug_outputs/artifacts"
...
open_run impl_1
report_timing_summary -file "$report_dir/timing_summary_oscilloscope_debug_outputs.rpt"
report_clocks -file "$report_dir/clocks_oscilloscope_debug_outputs.rpt"
report_utilization -file "$report_dir/utilization_oscilloscope_debug_outputs.rpt"
report_io -file "$report_dir/io_oscilloscope_debug_outputs.rpt"
report_drc -file "$report_dir/drc_oscilloscope_debug_outputs.rpt"
report_debug_core -full_path -file "$report_dir/debug_cores_oscilloscope_debug_outputs.rpt"
write_debug_probes -force $ltx_path

if {[file exists $bit_path]} {
    file copy -force $bit_path "$artifact_dir/laser_tx_board_top_oscilloscope_debug_outputs.bit"
}
if {[file exists $ltx_path]} {
    file copy -force $ltx_path "$artifact_dir/laser_tx_board_top_oscilloscope_debug_outputs.ltx"
}
file copy -force "$report_dir/timing_summary_oscilloscope_debug_outputs.rpt" "$artifact_dir/timing_summary_oscilloscope_debug_outputs.rpt"
file copy -force "$report_dir/debug_cores_oscilloscope_debug_outputs.rpt" "$artifact_dir/debug_cores_oscilloscope_debug_outputs.rpt"
file copy -force "$report_dir/utilization_oscilloscope_debug_outputs.rpt" "$artifact_dir/utilization_oscilloscope_debug_outputs.rpt"
file copy -force "$report_dir/io_oscilloscope_debug_outputs.rpt" "$artifact_dir/io_oscilloscope_debug_outputs.rpt"
file copy -force "$report_dir/drc_oscilloscope_debug_outputs.rpt" "$artifact_dir/drc_oscilloscope_debug_outputs.rpt"

set final ""
set artifact_bit_path "$artifact_dir/laser_tx_board_top_oscilloscope_debug_outputs.bit"
set artifact_ltx_path "$artifact_dir/laser_tx_board_top_oscilloscope_debug_outputs.ltx"
...
append final "timing_report=$report_dir/timing_summary_oscilloscope_debug_outputs.rpt\n"
append final "utilization_report=$report_dir/utilization_oscilloscope_debug_outputs.rpt\n"
append final "io_report=$report_dir/io_oscilloscope_debug_outputs.rpt\n"
append final "drc_report=$report_dir/drc_oscilloscope_debug_outputs.rpt\n"
append final "debug_report=$report_dir/debug_cores_oscilloscope_debug_outputs.rpt\n"
