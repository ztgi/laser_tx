...
module laser_gt_rate_switch_500m_1000m #(
    ...
    // Candidate IDs are appended so all existing PS/PL encodings remain
    // stable.  Software keeps these out of the verified rate-set list until
    // board bring-up has completed.
    localparam [3:0] RATE_ID_625M = 4'd10;
    localparam [3:0] RATE_ID_4000M = 4'd11;
    ...
    // Values are generated by the isolated 125 MHz CPLL Wizard parameter
    // package; see docs/debug_reports/37_625m_4000m_cpll_candidate_parameter_report.md.
    localparam [3:0] MMCM_DRP_SEQ_PROFILE9_625M = 4'd10;
    localparam [3:0] MMCM_DRP_SEQ_PROFILE10_4000M = 4'd11;
    ...
    function profile_supported;
        ...
        begin
            profile_supported = (rate_id == RATE_ID_500M) ||
                                ...
                                (rate_id == RATE_ID_625M) ||
                                (rate_id == RATE_ID_4000M);
        end
    endfunction
    ...
    function [15:0] profile_rate_mbps;
        ...
        begin
            ...
            RATE_ID_625M:  profile_rate_mbps = 16'd625;
            ...
            RATE_ID_4000M: profile_rate_mbps = 16'd4000;
    ...
    function [3:0] profile_mmcm_drp_seq_id;
        ...
        begin
            ...
            RATE_ID_625M:  profile_mmcm_drp_seq_id = MMCM_DRP_SEQ_PROFILE9_625M;
            RATE_ID_4000M: profile_mmcm_drp_seq_id = MMCM_DRP_SEQ_PROFILE10_4000M;
    ...
    function [2:0] profile_txout_div_enc;
        ...
        begin
            ...
            RATE_ID_625M:  profile_txout_div_enc = 3'b011;
            ...
            RATE_ID_4000M: profile_txout_div_enc = 3'b000;
    ...
    function [6:0] profile_cpll_fbdiv_enc;
        ...
        begin
            ...
            RATE_ID_625M:  profile_cpll_fbdiv_enc = 7'h03;
    ...
    function [31:0] profile_expected_txusrclk2_hz;
        ...
        begin
            ...
            RATE_ID_625M:  profile_expected_txusrclk2_hz = 32'd9765625;
            ...
            RATE_ID_4000M: profile_expected_txusrclk2_hz = 32'd62500000;
    ...
    function [23:0] profile_freq_min_count;
        ...
        begin
            ...
            RATE_ID_625M:  profile_freq_min_count = 24'd9600;
            ...
            RATE_ID_4000M: profile_freq_min_count = 24'd61400;
    ...
    function [23:0] profile_freq_max_count;
        ...
        begin
            ...
            RATE_ID_625M:  profile_freq_max_count = 24'd9950;
            ...
            RATE_ID_4000M: profile_freq_max_count = 24'd63600;
    ...
    function [15:0] mmcm_data_625m;
        ...
        begin
            ...
            5'd13: mmcm_data_625m = 16'h0800;
            default: mmcm_data_625m = 16'h9000;
            endcase
        end
    endfunction
    ...
    function [15:0] mmcm_data_4000m;
        ...
        begin
            ...
            5'd2:  mmcm_data_4000m = 16'h0080;
            5'd3:  mmcm_data_4000m = 16'h1041;
            5'd4:  mmcm_data_4000m = 16'h1145;
            ...
            5'd13: mmcm_data_4000m = 16'h0800;
            default: mmcm_data_4000m = 16'h1900;
            endcase
        end
    endfunction
    ...
    function [15:0] mmcm_data_for_seq;
        ...
        begin
            ...
            end else if (seq_id == MMCM_DRP_SEQ_PROFILE9_625M) begin
                mmcm_data_for_seq = mmcm_data_625m(index);
            end else if (seq_id == MMCM_DRP_SEQ_PROFILE10_4000M) begin
                mmcm_data_for_seq = mmcm_data_4000m(index);
            end else begin
                mmcm_data_for_seq = mmcm_data_500m(index);
            end
        end
