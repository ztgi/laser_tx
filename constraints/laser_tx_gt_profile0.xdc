...
# The package pins place the GTX channel in bank 111.  The GT Wizard profile
# uses CPLL, therefore no independent GTXE2_COMMON/QPLL location is needed.
# Direct out-of-context DCP insertion does not always carry the GT channel
# placement constraint into the top-level implementation, so keep the board lane
# location explicit here.  The TX differential pins AB2/AB1 correspond to the
