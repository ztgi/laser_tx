...
static const GtRateProfile gt_rate_profile_table[] = {
    { .rate_mbps = 500U,   .rate_id = LASER_RATE_ID_500M,   .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 7812500U, .eom_clk_hz = 125000000U, .eom_subdiv_log2 = 4U, .serial_bits_per_eom_tick = 4U, .freq_counter_min = 7700U,   .freq_counter_max = 7950U,   .cpll_drp_value = 0x1002U, .txout_div = 8U, .mmcm_profile_id = 1U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 625U,   .rate_id = LASER_RATE_ID_625M,   .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 9765625U, .eom_clk_hz = 156250000U, .eom_subdiv_log2 = 4U, .serial_bits_per_eom_tick = 4U, .freq_counter_min = 9600U,   .freq_counter_max = 9950U,   .cpll_drp_value = 0x1003U, .txout_div = 8U, .mmcm_profile_id = 10U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 1000U,  .rate_id = LASER_RATE_ID_1000M,  .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 15625000U, .eom_clk_hz = 125000000U, .eom_subdiv_log2 = 3U, .serial_bits_per_eom_tick = 8U, .freq_counter_min = 15400U,  .freq_counter_max = 15900U,  .cpll_drp_value = 0x1002U, .txout_div = 4U, .mmcm_profile_id = 2U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 1250U,  .rate_id = LASER_RATE_ID_1250M,  .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 19531250U, .eom_clk_hz = 156250000U, .eom_subdiv_log2 = 3U, .serial_bits_per_eom_tick = 8U, .freq_counter_min = 19200U,  .freq_counter_max = 19850U,  .cpll_drp_value = 0x1003U, .txout_div = 4U, .mmcm_profile_id = 4U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 2000U,  .rate_id = LASER_RATE_ID_2000M,  .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 31250000U, .eom_clk_hz = 125000000U, .eom_subdiv_log2 = 2U, .serial_bits_per_eom_tick = 16U, .freq_counter_min = 30800U,  .freq_counter_max = 31800U,  .cpll_drp_value = 0x1002U, .txout_div = 2U, .mmcm_profile_id = 3U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 2500U,  .rate_id = LASER_RATE_ID_2500M,  .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 39062500U, .eom_clk_hz = 156250000U, .eom_subdiv_log2 = 2U, .serial_bits_per_eom_tick = 16U, .freq_counter_min = 38400U,  .freq_counter_max = 39750U,  .cpll_drp_value = 0x1003U, .txout_div = 2U, .mmcm_profile_id = 5U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 3125U,  .rate_id = LASER_RATE_ID_3125M,  .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 48828125U, .eom_clk_hz = 195312500U, .eom_subdiv_log2 = 2U, .serial_bits_per_eom_tick = 16U, .freq_counter_min = 48000U,  .freq_counter_max = 49700U,  .cpll_drp_value = 0x1083U, .txout_div = 2U, .mmcm_profile_id = 7U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 4000U,  .rate_id = LASER_RATE_ID_4000M,  .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 62500000U, .eom_clk_hz = 125000000U, .eom_subdiv_log2 = 1U, .serial_bits_per_eom_tick = 32U, .freq_counter_min = 61400U,  .freq_counter_max = 63600U,  .cpll_drp_value = 0x1002U, .txout_div = 1U, .mmcm_profile_id = 11U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 5000U,  .rate_id = LASER_RATE_ID_5000M,  .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 78125000U, .eom_clk_hz = 156250000U, .eom_subdiv_log2 = 1U, .serial_bits_per_eom_tick = 32U, .freq_counter_min = 76800U,  .freq_counter_max = 79500U,  .cpll_drp_value = 0x1003U, .txout_div = 1U, .mmcm_profile_id = 6U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 6250U,  .rate_id = LASER_RATE_ID_6250M,  .pll_source = GT_RATE_PLL_CPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 97656250U, .eom_clk_hz = 195312500U, .eom_subdiv_log2 = 1U, .serial_bits_per_eom_tick = 32U, .freq_counter_min = 96000U,  .freq_counter_max = 99500U,  .cpll_drp_value = 0x1083U, .txout_div = 1U, .mmcm_profile_id = 8U, .qpll_n = 0U,  .qpll_required = 0U, .ad9528_dynamic_required = 0U, .board_verified = 1U },
    { .rate_mbps = 10000U, .rate_id = LASER_RATE_ID_10000M, .pll_source = GT_RATE_PLL_QPLL, .refclk_hz = 125000000U, .expected_txusrclk2_hz = 156250000U, .eom_clk_hz = 156250000U, .eom_subdiv_log2 = 0U, .serial_bits_per_eom_tick = 64U, .freq_counter_min = 153000U, .freq_counter_max = 159500U, .cpll_drp_value = 0x0000U, .txout_div = 1U, .mmcm_profile_id = 9U, .qpll_n = 80U, .qpll_required = 1U, .ad9528_dynamic_required = 0U, .board_verified = 1U }
};
